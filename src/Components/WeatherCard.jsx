...
const WeatherCard = ({
  ...
  return (
    <div className='w-[25rem] min-w-[22rem] h-[30rem] glassCard p-4'>
      ...
      <hr />
      <div className='w-full flex justify-center items-center gap-4 mt-5 mb-4'>
      ...
      <div className='w-full flex justify-between items-center mt-4 gap-4'>
        ...
        <p className='flex-1 text-center p-2 font-bold rounded-lg bg-yellow-500'>Humidity <p className='font-normal'>{humidity} gm/m&#179;</p></p>
      </div>
