  ...
  return (
    <div className='w-full h-screen text-white px-8'>
      <nav className='w-full p-3 flex justify-center items-center'>
        <div className='bg-white w-[25rem] overflow-hidden shadow-2xl rounded-3xl flex items-center p-2 gap-2'>
      ...
      <main className='w-full flex flex-col gap-8 py-4 px-[10%] items-center justify-center'>
        ...
        <div className='flex justify-center gap-8 flex-wrap w-[45%]'>
        {
